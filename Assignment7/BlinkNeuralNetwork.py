...
class BlinkNeuralNetwork(nn.Module):
    def __init__(self, pool = 'Max', conv1_out = 16, conv1_kernel_size = 5, conv2_out = 16, conv2_kernel_size = 3, nn1_out = 20):
        super(BlinkNeuralNetwork, self).__init__()

        self.conv1 = nn.Sequential(
            nn.Conv2d(1, conv1_out, kernel_size=conv1_kernel_size, stride=1, padding=2),
            nn.ReLU()
        )
